...
- [Version 3](./C/):
    - Tech stack: C/C++ Windows Forms

The current codebase in this repository provides a reference for the [rule](./rule.pdf) of the game.

Demo is available [here](http://memorydungeon.junbinzhang.com/)
